...
//写入答案
  ...
  mysql_query("INSERT INTO question(parent_qid,wjregID,type,title,question) 
  values('".$parent_qid."','".$wjregID."','".$type."','".$data[$x]."','".$data[$x+1]."');");
	}
	 unset($_SESSION['wjregID']);
