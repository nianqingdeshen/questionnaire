...
$sql="SELECT * from question where parent_qid=0 and wjregID=".$wjregID."limit ".($page-1)*$limit.",".$limit;
...
$sql2="SELECT * from question where parent_qid=0 and wjregID=".$wjregID;
