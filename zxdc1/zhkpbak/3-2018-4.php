...
$sql = "SELECT * from userinformation where not isBanned and (LevelID=2 OR LevelID=3 ) and DeptID != '".$result01['DeptID']."' LIMIT  90,30";
...
<script> 
	...
	        if(data.code==200){
	          	//alert("保存成功！");
				window.location.href="3-2018-5.php";
	        }else{
				alert("保存失败！");
	        }
	      },
