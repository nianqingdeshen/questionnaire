...
$sql = "SELECT * from userinformation where not isBanned and (LevelID=2 OR LevelID=3 ) AND userid NOT IN (SELECT bpuserid FROM zc_ldcykhinfo_472739 WHERE userid=".$_SESSION['MM_UserID'].") and DeptID != ".$result01['DeptID'];
//echo $sql ;
//获取结果集
