...
$sql = "SELECT * from userinformation where not isBanned and (LevelID=2 OR LevelID=3 ) AND userid NOT IN (SELECT bpuserid FROM zc_ldcykhinfo_472739 WHERE userid=".$_SESSION['MM_UserID'].")  order by DeptID, orderID  ";
//echo $sql ;
//获取结果集
...
?>
		...
		<div class="layui-form-item layui-col-xs-offset6">
        	<input class="layui-btn" type="button" onclick="test()" value="提交数据，完成该项任务。"/>
        </div>
	</form>
</body>
<script> 
