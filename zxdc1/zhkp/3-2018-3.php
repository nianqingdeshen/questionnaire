<?php require_once('../Connections/connjxkh.php');// require("checkvote.php");?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
<title>3.中层领导干部互评3</title> 
...
//查找每个部门中层领导的用户名和所属部门名称（条件：Rank=2或Rank=3）
$sql = "SELECT * from userinformation where not isBanned and (LevelID=2 OR LevelID=3 ) and DeptID != '".$result01['DeptID']."' LIMIT 60,30";
...
<script> 
	...
	        if(data.code==200){
	          	//alert("保存成功！");
				window.location.href="3-2018-4.php";
	        }else{
				alert("保存失败！");
	        }
	      },
