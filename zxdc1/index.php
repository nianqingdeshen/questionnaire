                    ...
                    <form>
                        <ul class="write switch" style="display: block;" id="write">
                            ...
                            <li id="role">
                                ...
                                <input type="radio" id="rdoTea" name="usertype" checked="checked" value="2">&nbsp;<label for="rdoTea">用户</label>&nbsp;&nbsp;&nbsp;
                            </li>
                            <li>
        ...
        <div style=" border-top: 1px solid #bac4cd; background-color: #f4f4f4;">
            <div class="footer clearfix">                
                <div class="logtext-box">
                    <p><span> <h3>© 2019 <?php echo iconv("GB2312","UTF-8",$zzmc.$ywbm);?>  </h3> </span></p>					
...
<script type="text/ecmascript" src="../../lib/jquery.md5.js"></script> 
    <script>
    ...
    function createCode(){
        ...
        function login_click(){
			...
			if(user.loginCode == "" || user.loginCode == null){
				...
				type:'POST',  //提交方法是POST
				url:'login.php', //请求的路径
				data:"username="+user.loginCode+"&password="+pwd+"&checkcode="+user.checkcode+"&usertype="+user.usertype+"&srand="+srand, //以JSON字符串形式把 user 传到后台
				...
				success:function(data){   //请求成功的回调方法
					...
					if(result == "loginmore"){
						...
						//若登录成功，跳转到"/main.html",用户界面
						window.location.href='menutest2.php';
					}else if(role == 1 &&result != "" && result == "success"){//部门管理员界面
